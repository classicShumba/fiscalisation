...
class AccountMove(models.Model):
    ...
    device_id = fields.Char(string='Device ID', compute='_compute_device_id', store=True)
    device_serial = fields.Char(string='Device Serial', compute='_compute_device_serial', store=True)
    receipt_global_number = fields.Char(string='Receipt Global Number', copy=False)
    receipt_number = fields.Char(string='Receipt Number', copy=False)
    fiscal_day_no = fields.Char(string='Fiscal Day', copy=False)
    verification_code = fields.Char(string='Verification Code', copy=False)
    fiscalised = fields.Boolean(string='Fiscalised', default=False, copy=False)
